...
**FLOW TO RUN THE PROJECT**<BR>
  
  Run the following files accordingly....<br>
  
  1. <mark>model.ipynb<mark>
  2. detection.py (which will create two more files named )
  3. email_intimation.py
  4. sound_intimation.py
  5. camera.py
  6. main.py (execution of the project)<br>
